...
/**
 * (package-private)<br>
 * Spirtech HSM reader extension adapter.
 *
 * @since 2.0.0
 */
final class SpirtechHsmReaderAdapter implements SpirtechHsmReader, ReaderSpi {

  private static final Logger logger = LoggerFactory.getLogger(SpirtechHsmReaderAdapter.class);
  ...
  /**
   * (package-private)<br>
   * This constructor should only be called by allocateReader from {@link SpirtechHsmPluginAdapter}
   *
   * @param csmChannel the {@link CsmChannel}
   * @since 2.0.0
   */
  SpirtechHsmReaderAdapter(CsmChannel csmChannel) throws CsmException {
    this.name =
