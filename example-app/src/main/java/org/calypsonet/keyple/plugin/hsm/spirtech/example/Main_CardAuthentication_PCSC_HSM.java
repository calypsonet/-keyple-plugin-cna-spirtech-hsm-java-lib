 ...
 ************************************************************************************** */
package org.calypsonet.keyple.plugin.hsm.spirtech.example;

import static org.calypsonet.keyple.plugin.hsm.spirtech.example.ConfigurationUtil.getCardReader;
import static org.calypsonet.keyple.plugin.hsm.spirtech.example.ConfigurationUtil.setupCardResourceService;

import org.calypsonet.keyple.plugin.hsm.spirtech.SpirtechHsmPluginFactoryProvider;
 ...
 *
 *
 * <h1>Calypso Card authentication (PC/SC)</h1>
 *
 ...
 * virtual Calypso SAM provided by a Spirtech HSM.
 *
...
public class Main_CardAuthentication_PCSC_HSM {
  ...
  public static void main(String[] args) {
    ...
    // Register the SpirtechHsmPlugin used for SAMs
    PoolPlugin hsmPlugin =
        (PoolPlugin) smartCardService.registerPlugin(SpirtechHsmPluginFactoryProvider.getFactory());

    // Get and set up the card reader
    // We suppose here, we use an ASK LoGO contactless PC/SC reader as card reader.
    CardReader cardReader = getCardReader(pcscPlugin, ConfigurationUtil.CARD_READER_NAME_REGEX);

    // Configure the card resource service to provide an adequate SAM for future secure operations.
    // We use a Spirtech HSM.
